        ...
        <div>
            ...
            <div className=" w-1/2 mx-auto mt-20 bg-slate-100 rounded-2xl">
                ...
                <div className="">
                    ...
                    <div className="">
                        <input className="mt-5 btn" type="submit" value='Register' />
                    </div>
                    <p className="mt-10 text-center">All Ready Have An Account <Link className="underline font-bold text-blue-500" to='/login'>login</Link></p>
                </form>
            </div>
        </div>
    );
